...
Exploratory analysis of the Titanic dataset focusing on how demographic and socioeconomic factors influence passenger survival, using structured data wrangling and visual analytics.

### Titanic Machine Learning Classification
Supervised machine learning project applying logistic regression to predict Titanic passenger survival, with emphasis on feature preparation, model evaluation, and interpretability.

### Data Analysis Techniques
A collection of core data analysis workflows including data cleaning, dataset merging, pivot-based aggregation, and time-series analysis applied across multiple datasets.
